...
<div class="container card text-white bg-light" style="box-shadow: 5px 5px 10px gray">
    <br />
 <h2>Lista de Clientes <a href="client/create"> <button type="button" class="btn btn-success float-right"><img src="{{asset('dist/img/add.png')}}">Agregar usuario</button></a> </h2>

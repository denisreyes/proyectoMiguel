...
<body class="hold-transition sidebar-mini layout-fixed" >
    <div id="app">
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-info elevation-4 sidebar">
                <!-- Brand Logo -->
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="{{asset('dist/img/project.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                        style="opacity: .8">
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <li class="nav-item">
                                <a href="{{url('usuarios')}}"
                                    ...
                                    <p>
                                        ...
                                        <span class="right badge badge-primary">{{ $users_count ?? '0' }}</span>
                                    </p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{url('proveedores')}}"
                                    ...
                                    <p>
                                        Proveedores
                                        <?php use App\Models\Provider; $providers_count = Provider::all()->count(); ?>
                                        <span class="right badge badge-primary">{{ $providers_count ?? '0' }}</span>
                            ...
                            <li class="nav-item">
                                <a href="{{url('clients')}}"
                                    ...
                                    <p>
                                        Clientes
                                        <?php use App\Models\Client; $clients_count = Client::all()->count(); ?>
                                        <span class="right badge badge-primary">{{ $clients_count ?? '0' }}</span>
                            ...
                            <li class="nav-item">
                                <a href="{{url('product')}}"
                                    ...
                                    <p>
                                        Productos
                                        <?php use App\Models\Product; $products_count = Product::all()->count(); ?>
                                        <span class="right badge badge-primary">{{ $products_count ?? '0' }}</span>
                            ...
                            <li class="nav-item">
                                <a href="{{url('sales')}}"
                                    class="{{ Request::path() === 'sales' ? 'nav-link active' : 'nav-link' }}">
                                    <i class="fas fa-credit-card"></i>
                                    <p>
                                        Ventas
                                        <?php use App\Models\Sales; $sales_count = Sales::all()->count(); ?>
                                        <span class="right badge badge-primary">{{ $sales_count ?? '0' }}</span>
            ...
            <div class="content-wrapper" style="background-color: #CDCDCD">
